...
public:
    ...
    // El destructor virtual para no tener fugas de memoria
    virtual ~Equipo() {}
...
int main() {
    // EL puntero nos permitira realizar polimorfismo
    ...
    do {
        ...
        if (opcion == 1) {
            ...
            for (int i = 0; i < inventario.size(); i++) {
                // llama a la funcion de la clase hija
